...
- [Audience input UI:](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) Intrapology allows audience members to contribute via [multiple-choice](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) and [free-response](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) questions.
...
- Intrapology facilitates both fully-online and hybrid performances, by integrating [a live video stream](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) into the UI. This allows performances built using Intrapology to be accessible to people who face barriers to in-person venues.
- Intrapology includes a built-in subtitles interface which:
    - Automatically generates subtitles from the performance script.
    - [Displays subtitles](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) in sync with the performance.

## Example

Here is a recording of a real performance built with a previous version of our software:

[https://peertube.intrapology.com/videos/embed/262dc402-e14a-42bd-86d9-04a306f9c819](https://peertube.intrapology.com/videos/embed/262dc402-e14a-42bd-86d9-04a306f9c819)
...
A member of your crew who is responsible for controlling the pace of the performance. The Intrapology software automatically handles tasks such as displaying the current line of dialogue to the relevant actor and gathering audience input. However,Intrapology is designed to be used for performances where the exact content, and therefore timing, is unknown ahead of time. So in order for Intrapology to know when it is time to advance to the next line of dialogue, [manual input from a moderator is needed](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21).

### Actors

People who will be portraying characters in the performance. Each actor gets their own page of the [Actor View](https://www.notion.so/Actor-View-41f14d892bf74cc48f834418a56bd64f?pvs=21), which displays the current line, if any, for their character.

### Audience Input

The audience also [plays an active role](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) in the formal flow of the performance, through voting on multiple-choice questions as well as reponding to free-responce prompts.

## User Interface

During a performance, Intrapology provides four different views:

1. [Audience View](https://www.notion.so/Audience-View-dcf2f909c1774db381d1aab76a7a4cc3?pvs=21) 
2. [Subtitles View](https://www.notion.so/Subtitles-View-6e177eaef6fc428cb2e3cb521c4e8481?pvs=21) 
3. [Moderator View](https://www.notion.so/Moderator-View-185b780141154089a86958e6ea975511?pvs=21) 
4. [Actor View](https://www.notion.so/Actor-View-41f14d892bf74cc48f834418a56bd64f?pvs=21) 
...
1. The main area of the audience view displays [the video feed](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) for the performance.
2. The audience input area of the audience view is where audience members can select options during a multiple-choice vote or write whatever text they would like during an audience free-response portion of a performance. When audience input is not being accepted, some placeholder text will be displayed. The default placeholder text is “You don't have to do anything right now - just sit back and enjoy the show!”. You can change the placeholder text to something else by changing the value of the [`"defaultAudienceMessage"` option](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) in `intrapology-hello-world/settings.json`.

![ui_audience_annotated.jpeg](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_audience_annotated.jpeg)

During an audience vote, the input section of the Audience view will present audience members with some text prompting them to select an option, and buttons for each option available. The text for each option button includes the number of votes which that option has received. The button for the option which currently has the most votes will be tagged with a “⭐️ winning” label. The vote counts and winning tag are updated in real time. If an audience member has selected an option then the relevant button will be tagged with a “✅ selected” label.

![ui_audience_vote.png](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_audience_vote.png)
...
![ui_audience_rant.png](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_audience_rant.png)
...
![ui_subtitles.png](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_subtitles.png)
...
Accessing the moderator view requires entering a password. The password is “butts” by default, but you can [set a different password](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21).
...
![ui_mod_vote.png](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_mod_vote.png)

Here is an example of the moderator view during audience free-response:

![ui_mod_rant.png](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_mod_rant.png)
...
![ui_actor_character_select.png](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_actor_character_select.png)
...
![ui_actor_dialogue.png](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_actor_dialogue.png)

Here is an example of what the actor for the character named “Apple” sees when another character is speaking:

![ui_actor_not_speaking.png](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_actor_not_speaking.png)
...
![ui_actor_rant.png](Drafting%20b673aa2f95884e608f6ad490257f101a/ui_actor_rant.png)
...
[https://youtu.be/6ZYJqcMQGjw](https://youtu.be/6ZYJqcMQGjw)
...
![hello_world_github_crop_1_annotated.png](Drafting%20b673aa2f95884e608f6ad490257f101a/hello_world_github_crop_1_annotated.png)
...
![hello_world_github_crop_2_annotated.png](Drafting%20b673aa2f95884e608f6ad490257f101a/hello_world_github_crop_2_annotated.png)
...
The ‘ID’ of your performance is a unique name that is used to distinguish it from other performances. The performance ID is not the title of your performance that is shown to the audience. For setting the title of your performance that will be displayed in the audience view, see [this section](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21).
...
3. Click the “Launch Browser” button, located next to the “Start” button. This should open the [audience view](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) of the Intrapology template performance in your default web browser.

![servez_annotated.png](Drafting%20b673aa2f95884e608f6ad490257f101a/servez_annotated.png)
...
Writing the name of a character (in this case “Apple” or “Banana”), followed by a colon “:”, followed by some text means ‘the character with this name says this text’. When each line of dialogue is reached during a performance, the Intrapology interface will show it to the relevant performer. Audience members who have loaded the [Subtitles View](https://www.notion.so/Subtitles-View-6e177eaef6fc428cb2e3cb521c4e8481?pvs=21) will be shown the line of dialogue as well. The moderator view also displays the current line of dialogue.

<aside>
💡

Remember: all character names used for dialogue in your script must be listed via the [`"callers"` option](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) in `settings.json`. Since “Apple” and “Banana” are already specified by default for the Intrapology Hello World template, no action is required for the current script to function properly. However, if you write a script with differently named characters, you will need to update `settings.json` accordingly.
...
If you have not already done so, you must [set a unique Performance ID](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) and [install and set up Servez](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) before continuing.
...
[https://youtu.be/zlUqGzYOU4M](https://youtu.be/zlUqGzYOU4M)
...
1. [Multiple-Choice Audience Input](https://www.notion.so/Multiple-Choice-Audience-Input-c890f42a460d44259ac9ebc7406f49ba?pvs=21) 
2. [Flow and Choice Branching](https://www.notion.so/Flow-and-Choice-Branching-1c3159ce973248069e22ada21af28880?pvs=21) 
3. [Gathers](https://www.notion.so/Gathers-6471fd44ee684b37af1a0c54a1dc9dfa?pvs=21) 
4. [Free-Response Audience Input](https://www.notion.so/Free-Response-Audience-Input-31994d0b48ce4ed0b7cb70af92557de4?pvs=21) 
5. [Variables](https://www.notion.so/Variables-8f92202cdc3148f7acbf362dc3bd207e?pvs=21) 
...
1. A block of text prefixed with the `@` symbol. This text will be shown to the audience at the top of [the audience view](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21) UI during the voting period. The placement of this block of text determines at what point in the performance the audience vote UI becomes visible.
...
- **Dialogue**: `Apple: Hi, I'm the first video caller!`  means ‘the character named `Apple` says “Hi, I’m the first video caller!”’. This will be shown to the performer for the Apple character via their [Actor View](https://www.notion.so/Actor-View-41f14d892bf74cc48f834418a56bd64f?pvs=21) .
...
Change colours, fonts, and backgrounds here. For a list of available options with examples, go to this section: [Customizations to Visual Presentation (`settings.json` styles)](https://www.notion.so/Customizations-to-Visual-Presentation-settings-json-styles-4e0729472f8e4e30a5fe21295d744cb8?pvs=21).
...
**Type:** [Background](https://www.notion.so/Background-f8ab09e003184175955ecb393efa6978?pvs=21) 

This determines the background color/image for the [main area of the Audience View](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21). By default this is set to an animated image of flickering stars.

Here is an example of what the Audience View UI looks like when `desktopBackground` has been set to “fuchsia”:

![desktopBackground-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/desktopBackground-fuchsia.png)

### **interactBackground**

**Type:** [Background](https://www.notion.so/Background-f8ab09e003184175955ecb393efa6978?pvs=21) 

This determines the background color/image for the [audience input area of the Audience View](https://www.notion.so/Drafting-b673aa2f95884e608f6ad490257f101a?pvs=21). By default this is set to a slightly transparent black.

Here is an example of what the Audience View UI looks like when `interactBackground` has been set to “fuchsia”:

![interactBackground-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/interactBackground-fuchsia.png)

### **mainFont**

**Type:** [Font](https://www.notion.so/Font-473ff1ca08554af9b021caab6628bdee?pvs=21) 
...
![mainFont-cursive.png](Drafting%20b673aa2f95884e608f6ad490257f101a/mainFont-cursive.png)

### **mainTextColor**

**Type:** [Color](https://www.notion.so/Color-461f85e3ada5453e92986fb9f89d2e9c?pvs=21)
...
![mainTextColor-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/mainTextColor-fuchsia.png)
...
![taskbarBackground-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/taskbarBackground-fuchsia.png)
...
![taskbarTextColor-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/taskbarTextColor-fuchsia.png)
...
![taskbarHighlightColor-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/taskbarHighlightColor-fuchsia.png)
...
![buttonBackground-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/buttonBackground-fuchsia.png)
...
![buttonBackgroundHover-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/buttonBackgroundHover-fuchsia.png)
...
![buttonTextColor-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/buttonTextColor-fuchsia.png)
...
![mainHighlightBackground-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/mainHighlightBackground-fuchsia.png)
...
![altHighlightBackground-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/altHighlightBackground-fuchsia.png)
...
![highlightTextColor-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/highlightTextColor-fuchsia.png)
...
![subtitlesBackground-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/subtitlesBackground-fuchsia.png)
...
![subtitlesTextColor-fuchsia.png](Drafting%20b673aa2f95884e608f6ad490257f101a/subtitlesTextColor-fuchsia.png)
